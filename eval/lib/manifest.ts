// The corpus layout the builder writes and the scorer reads: eval/corpus/manifest.json lists units, and each unit has a
// unit.json with its analyzed files, provenance and ground truth, plus a tree/ directory that is copied to a work
// directory and analyzed with that directory as the working directory.
import {existsSync, readFileSync} from 'node:fs'
import {dirname, join} from 'node:path'

export type Slice = 'mj-gallery' | 'families' | 'replay'
...
// A manifest past this size is a builder bug, not a corpus: the night corpus has a few dozen units.
