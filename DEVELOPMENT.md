...
- [src/facts.ts](./src/facts.ts), [src/assumptions.ts](./src/assumptions.ts), [src/linear.ts](./src/linear.ts), [src/proof.ts](./src/proof.ts), and [src/proof-rules.ts](./src/proof-rules.ts) — published facts, assumptions and branch choices, reachability, linear expressions, and comparison proof rules
