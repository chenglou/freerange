...
- [src/interpreter/](./src/interpreter) — fresh parallel abstract interpreter core, source-shape readers, branch refinement, loop effects/value transforms, value-path writes, and value-tree snapshot formatting
