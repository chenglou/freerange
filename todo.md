...
- `items.at(-1)` works for non-empty arrays. It intentionally does not support `.at(-2)`, dynamic `.at(index)`, or same-loop "append then read previous last" recurrences yet.
