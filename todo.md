...
- Function boundaries include named `function` declarations, named `const` arrow/function expressions, and class methods/getters. Instance class members can use `this` as an input root.
