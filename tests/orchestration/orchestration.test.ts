...
const testFiles = [
  ...
  {path: 'tests/interpreter/interpreter.test.ts', registrations: 5},
  {path: 'tests/interpreter/math-numeric.test.ts', registrations: 1},
  {path: 'tests/loops/loops.test.ts', registrations: 10},
  {path: 'tests/numeric/architecture.test.ts', registrations: 2},
  {path: 'tests/numeric/grid.test.ts', registrations: 2},
  {path: 'tests/numeric/linear.test.ts', registrations: 2},
