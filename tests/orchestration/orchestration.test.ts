...
const testFiles = [
  ...
  {path: 'tests/numeric/architecture.test.ts', registrations: 1},
  {path: 'tests/numeric/linear.test.ts', registrations: 4},
  {path: 'tests/numeric/math.test.ts', registrations: 1},
  {path: 'tests/numeric/operations.test.ts', registrations: 4},
