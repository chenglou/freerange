...
//
// The type classifier `classify` (depth 8), the leading-assert parser (`applyCondition`, `conjuncts`) and domain@v2 rules 1-3:
...
//      `size.width * 3` is not a read, so its callee requirement stays a call-site check.
