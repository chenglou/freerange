...
// Ported unchanged from mutation-instrument-spike at bccf0dd (mutation-instrument/encode.ts), except this comment.
...
/** e.g. `virtualizedGridLayout(0, 0, 1, 0, null, null, 0)`; trailing undefined arguments are dropped. */
