// Input domains and number value sources for domain@v2 and lattice@v1. capUnboundedEnds takes the cap as a parameter
// (FREERANGE_SWEEP_CAP). A domain is what an entry function accepts: its parameter types narrowed by the entry's leading
