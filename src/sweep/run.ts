...
// with every import specifier resolved to an absolute path, and runs child.ts there under limits: a process group, an
// environment allowlist, a load step, an RSS poller and an output cap.
