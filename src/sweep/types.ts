...
// Types only. Ported from mutation-instrument-spike at bccf0dd (mutation-instrument/types.ts); the plan, mutant, caller-rule
// and contract-writing types are not ported.
